    ...
    <section className="py-12 md:py-20 bg-background overflow-hidden">
      <div ref={ref} className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            A dedicated group of visionaries committed to transforming your
            ideas into reality.
          </motion.p>
        </div>
...
function MemberCard({
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden mb-6 aspect-[4/5] bg-muted w-full rounded-lg shadow-lg">
        <img
          src={member.image}
          alt={member.name}
      ...
      <div className="text-muted-foreground text-sm leading-relaxed max-w-prose mx-auto text-center">
        {!isExpanded ? (
          <p>{shortText}</p>
        ) : (
